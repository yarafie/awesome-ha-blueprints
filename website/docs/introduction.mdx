...
The **Awesome HA Library 1.0** is the structured evolution of the original blueprint collection by @EPMatt.

It organizes **Controllers**, **Hooks**, and **Automations** into versioned, maintained libraries, making it easier to discover, compare, and update blueprints over time.

Each library groups related releases and versions under a clear ownership and documentation model, while keeping usage simple and UI-driven.

## Overview

With the **Home Assistant 2020.12 Release**, an exciting new feature was introduced: _Blueprints_.
...
**Awesome HA Library** aims to be a curated library of automation blueprints for Home Assistant, which can then be easily imported and updated in any Home Assistant instance. Each blueprint included in the collection is:
...
The **ultimate goal** of Awesome HA Library is to **develop a highly valuable resource** for Home Assistant newcomers who would like to include **complex automations** in their home automation setups **with just a few clicks**, without even touching a single line of code.
...
Loving Awesome HA Library and want to help? Thanks! There are plenty of ways you can contribute.<br/>New or updates to blueprints and documentation, as well as any suggestion on organization, guidelines, or anything else that can improve the interaction with the project would be highly appreciated.
