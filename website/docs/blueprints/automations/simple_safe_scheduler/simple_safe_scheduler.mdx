...
<ImportCard id='simple_safe_scheduler' category='automations' />
...
<Inputs category='automations' id='simple_safe_scheduler' />
...
<Changelog category='automations' id='simple_safe_scheduler' />
