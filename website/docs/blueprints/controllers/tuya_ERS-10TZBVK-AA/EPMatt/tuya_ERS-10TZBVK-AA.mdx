...
<ImportCard id='tuya_ERS-10TZBVK-AA' category='controllers' variant='EPMatt' />
...
Hooks allow to easily create controller-based automations for interacting with lights, media players, covers and maybe more in the future. See the list of [Hooks available for this controller](/docs/blueprints/controllers/tuya_ERS-10TZBVK-AA/EPMatt/tuya_ERS-10TZBVK-AA#available-hooks) for additional details.
:::
...
<Changelog category='controllers' id='tuya_ERS-10TZBVK-AA' variant='EPMatt' />
