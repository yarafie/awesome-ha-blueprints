...
<ImportCard id='tuya_ZG-101Z-D' category='controllers' variant='EPMatt' />
...
Hooks allow to easily create controller-based automations for interacting with lights, media players, covers and maybe more in the future. See the list of [Hooks available for this controller](/docs/blueprints/controllers/tuya_ZG-101Z-D/EPMatt/tuya_ZG-101Z-D#available-hooks) for additional details.
:::
...
<Inputs category='controllers' id='tuya_ZG-101Z-D' variant='EPMatt' />
...
<Changelog category='controllers' id='tuya_ZG-101Z-D' variant='EPMatt' />
