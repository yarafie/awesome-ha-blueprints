...
<ImportCard id='shelly_button_1' category='controllers' variant='EPMatt' />
...
Hooks allow to easily create controller-based automations for interacting with lights, media players, covers and maybe more in the future. See the list of [Hooks available for this controller](/docs/blueprints/controllers/shelly_button_1/EPMatt/shelly_button_1#available-hooks) for additional details.
:::
...
<Changelog category='controllers' id='shelly_button_1' variant='EPMatt' />
