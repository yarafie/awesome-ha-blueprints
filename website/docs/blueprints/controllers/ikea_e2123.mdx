...
However Long and Double press events can be disabled for the dots1/dots2 buttons to get extra speed in recognizing single press events by enabling initial press actions.
...
/>
<Input
  name='Dots1/Dots2 button initial press - enable/disable'
  description='Enable/Disable the Dots buttons initial press custom actions. If enabled Long Press and Double press will be disabled for the dots buttons.'
  selector='boolean'
/>
<Input
...
- **2025-03-16**: Added ability to enable initial press actions for dots buttons. [issue#70] ([@yarafie](https://github.com/yarafie))
