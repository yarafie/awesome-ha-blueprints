...
- Right button short press -> Right button short press
- Left button short press -> Left button short press
...
- Down button short press -> Volume up
- Down button long press -> Volume up (continuous, until release)
