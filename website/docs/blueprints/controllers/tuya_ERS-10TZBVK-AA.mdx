...
/>
<Input
  name='Expose Click button double press event'
  description='Choose whether or not to expose the virtual double press event for the click button. Turn this on if you are providing an action for the click button double press event.'
  selector='boolean'
/>
<Input
