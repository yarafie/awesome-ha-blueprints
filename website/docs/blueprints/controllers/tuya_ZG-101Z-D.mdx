...
description: Controller automation for executing any kind of action triggered by the provided Tuya ZG-101Z/D Smart knob. Supports Zigbee2MQTT, ZHA.
model: ZG-101Z/D
manufacturer: Tuya
...
<ImportCard id='tuya_tuya_ZG-101Z-D' category='controllers' />
...
Hooks allow to easily create controller-based automations for interacting with lights, media players, covers and maybe more in the future. See the list of [Hooks available for this controller](/docs/blueprints/controllers/tuya_tuya_ZG-101Z-D#available-hooks) for additional details.
:::
...
<Inputs category='controllers' id='tuya_tuya_ZG-101Z-D' />
...
- **2025-10-14**: Initial release. ([@yarafie](https://github.com/yarafie)) :tada:
