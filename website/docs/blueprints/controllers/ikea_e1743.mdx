...
- **2025-10-12**: Refactored blueprint to use triggers and trigger-id, removed having to supply integration type and removed last controller helper logic. ([@yarafie](https://github.com/yarafie))
