...
Hooks allow to easily create controller-based automations for interacting with lights, media players, covers and maybe more in the future. See the list of [Hooks available for this controller](/docs/blueprints/controllers/philips_929002398602#available-hooks) for additional details.
:::
...
- **2025-04-17**: Add additional manufacturer name for zha/deConz. [EPMatt-issue#766] ([@yarafie](https://github.com/yarafie))
- **2025-04-19**: Update blueprint with button optimizations. [EPMatt-issue#713] ([@yarafie](https://github.com/yarafie))
- **2025-10-16**: Changed short button presses to use \_press_release. [EPMatt-issue#934] ([@queimadus](https://github.com/queimadus)) ([@yarafie](https://github.com/yarafie))
