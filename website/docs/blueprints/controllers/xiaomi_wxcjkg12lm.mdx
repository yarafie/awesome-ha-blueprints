...
description: Controller automation for executing any kind of action triggered by the provided Xiaomi WXCJKG12LM Aqara Opple 4 button remote. Supports deCONZ, ZHA, Zigbee2MQTT.
---
