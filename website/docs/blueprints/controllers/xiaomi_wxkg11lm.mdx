...
description: Controller automation for executing any kind of action triggered by the provided Xiaomi WXKG11LM Aqara Wireless Switch Mini. Supports Zigbee2MQTT, ZHA, deCONZ.
---
