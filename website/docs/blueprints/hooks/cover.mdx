...
- [Shelly SHBTN-2 Button 1](/docs/blueprints/controllers/shelly_shbtn_2)
...
- **2025-03-01**: Added support for IKEA E2213 SOMRIG shortcut button. ([@yarafie](https://github.com/yarafie))
- **2025-03-01**: Added support for IKEA E2123 SYMFONISK sound remote, gen 2. ([@yarafie](https://github.com/yarafie))
- **2025-03-20**: Added support for IKEA E2201 RODRET Dimmer. ([@yarafie](https://github.com/yarafie))
- **2025-03-25**: Added support for Shelly SHBTN-2 Button 1. ([@yarafie](https://github.com/yarafie))
