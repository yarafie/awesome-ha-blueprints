...
- **2025-xx-xx**: Added support for Shelly Button 1. ([@yarafie](https://github.com/yarafie))
- **2025-xx-xx**: Added support for Shelly SNSN-0024x Plus i4 with Wall switch 4. ([@yarafie](https://github.com/yarafie))
- **2025-xx-xx**: Added support for Aqara WXKG13LM Wireless Mini Switch T1. ([@yarafie](https://github.com/yarafie))
