...
- [Aqara WXKG13LM Wireless Mini Switch T1](/docs/blueprints/controllers/aqara_wxkg13lm)
...
- [Shelly Button 1](/docs/blueprints/controllers/shelly_button_1)
- [Shelly SNSN-0024x Plus i4 with Wall switch 4](/docs/blueprints/controllers/shelly_snsn_0024x)
...
- **2025-03-25**: Added support for Shelly SNSN-0024x Plus i4 with Wall switch 4. ([@yarafie](https://github.com/yarafie))
...
- **2025-04-12**: Added support for Shelly Button 1. ([@yarafie](https://github.com/yarafie))
- **2025-04-12**: Added support for Aqara WXKG13LM Wireless Mini Switch T1. ([@yarafie](https://github.com/yarafie))
- **2025-10-20**: Added support for IKEA E2001/E2002 STYRBAR Remote control. ([@yarafie](https://github.com/yarafie))
