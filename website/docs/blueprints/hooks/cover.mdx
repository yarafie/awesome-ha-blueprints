...
- **2025-03-xx**: Added support for Shelly SHBTN-2 Button 1. ([@yarafie](https://github.com/yarafie))
- **2025-03-xx**: Added support for Shelly SNSN-0024x Plus i4 with Wall switch 4. ([@yarafie](https://github.com/yarafie))
