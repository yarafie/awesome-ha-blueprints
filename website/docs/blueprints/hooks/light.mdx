...
<Requirement id='controllers' required/>
...
- [Tuya ZG-101Z/D Smart knob](/docs/blueprints/controllers/tuya_ZG-101Z-D)
...
- **2025-03-03**: Added support for Smarthjemmet.dk QUAD-ZIG-SW 4 button remote. ([@Nicolai-](https://github.com/Nicolai-))
...
- **2025-10-13**: Added support for Tuya ZG-101Z/D Smart knob. ([@yarafie](https://github.com/yarafie))
