...
- [Smarthjemmet.dk QUAD-ZIG-SW 4 button remote](/docs/blueprints/controllers/smarthjemmet_dk_quad_zig_sw)
...
- **2025-02-20**: Use default int when value is none ([PR#22](https://github.com/yarafie/awesome-ha-blueprints/pull/22)). ([@mwinkler](https://github.com/mwinkler))
- **2025-02-28**: Added support for Smarthjemmet.dk QUAD-ZIG-SW 4 button remote. ([@Nicolai-](https://github.com/Nicolai-))
- **2025-02-28**: Added support for Tuya ERS-10TZBVK-AA Smart knob. ([@yarafie](https://github.com/yarafie))
