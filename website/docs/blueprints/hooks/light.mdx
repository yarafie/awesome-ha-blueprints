...
- **2025-02-29**: Added support for Tuya ERS-10TZBVK-AA Smart knob. ([@yarafie](https://github.com/yarafie))
- **2025-02-xx**: Added support for Smarthjemmet.dk QUAD-ZIG-SW 4 button remote. ([@Nicolai-](https://github.com/Nicolai-))
