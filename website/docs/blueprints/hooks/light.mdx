...
- **2025-02-14**: Use default int when value is none ([PR#22](https://github.com/yarafie/awesome-ha-blueprints/pull/22)). ([@mwinkler](https://github.com/mwinkler))
- **2025-02-14**: Added support for IKEA E2201 RODRET Dimmer. ([@yarafie](https://github.com/yarafie))
