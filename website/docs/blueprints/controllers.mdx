...
Currently **22** devices are supported from **8** different vendors.
...
| IKEA            | [E2123](/docs/blueprints/controllers/ikea_e2123)                        | IKEA E2123 SYMFONISK sound remote, gen 2          | Zigbee2MQTT,ZHA,deCONZ | <Image>![ikea_e2123](/img/controllers/ikea_e2123.png)</Image>                                   |
...
| IKEA            | [E2213](/docs/blueprints/controllers/ikea_e2213)                        | IKEA E2213 SOMRIG shortcut button                 | Zigbee2MQTT,ZHA,deCONZ | <Image>![ikea_e2213](/img/controllers/ikea_e2213.png)</Image>                                   |
...
| Smarthjemmet.dk | [QUAD-ZIG-SW](/docs/blueprints/controllers/smarthjemmet_dk_quad_zig_sw) | smarthjemmet.dk QUAD-ZIG-SW                       | Zigbee2MQTT            | <Image>![smarthjemmet_dk_quad_zig_sw](/img/controllers/smarthjemmet_dk_quad_zig_sw.png)</Image> |
...
| Tuya            | [ERS-10TZBVK-AA](/docs/blueprints/controllers/tuya_ERS-10TZBVK-AA)      | Tuya ERS-10TZBVK-AA Smart knob                    | Zigbee2MQTT,ZHA        | <Image>![tuys_ERS-10TZBVK-AA](/img/controllers/tuya_ERS-10TZBVK-AA.png)</Image>                 |
