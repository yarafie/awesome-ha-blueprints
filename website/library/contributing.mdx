...
7. **Update the blueprint docs** in the website/library_docs/blueprints section:
   - Copy the example documentation file in a new folder for the blueprint:
     ```sh
     cp website/library_docs/blueprints/automation/example.mdx website/library_docs/blueprints/automation/my-new-blueprint.mdx
     ```
...
6. **Update the blueprint docs**, in the `website/library_docs/blueprints` section, according to your changes. Make sure to add an entry to the **Changelog** at the bottom of the page.
